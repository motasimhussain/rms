...
<<<<<<< HEAD
		...
		echo '<script>var result ="'; echo $registererror; echo '"; type="user_add"; jpopup(result,type);</script>';
		}
...
<<<<<<< HEAD
		...
		echo '<script>var result ="'; echo $registererror; echo '"; type="admin_reg"; jpopup(result,type);</script>';
		}
