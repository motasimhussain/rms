...
<<<<<<< HEAD
		...
		$subject =  strtolower(ereg_replace(" ","_",$subject_temp));
		$year = isset($_POST['year']) ? $_POST['year'] : '';
		$semester = isset($_POST['semester']) ? $_POST['semester'] : '';
		$field = isset($_POST['field']) ? $_POST['field'] : '';
		$section = isset($_POST['section']) ? $_POST['section'] : '';
		$teach_temp = isset($_POST['teacher']) ? $_POST['teacher'] : '';
		$teacher = strtolower(ereg_replace(" ","_",$teach_temp));
...
<div id = "heading-content">
	...
	<td> <?php echo "<p><b>Teacher:</b> " .ereg_replace("_"," ",$teacher);?></td>
	</tr>
	<tr>
	<td> <?php echo "<p><b>Semester:</b> " .ereg_replace("s"," ",$semester)."</p>";?></td>
	<td><?php echo "<p><b>Field:</b> " .strtoupper($field)."</p>";?></td>
	<td><?php echo "<p><b>Section:</b> " .ereg_replace("_"," ",$section). "</p>";?></td>
	</tr>
	</table>
=======
    $subject_temp = isset($_POST['subject']) ? $_POST['subject'] : '';
