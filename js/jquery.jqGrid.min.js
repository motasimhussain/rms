...
(function (b) {
    b.jgrid = b.jgrid || {};
    b.extend(b.jgrid, {version:"4.4.1", htmlDecode:function (b) {
        ...
        var c =
        {m:1, d:1, y:1970, h:0, i:0, s:0, u:0}, d, a, g;
        d = /[\\\/:_;.,\t\T\s-]/;
        ...
        return new function (e, c) {
            ...
            this.orderBy = function (a, c, g, f) {
                ...
                v.push({by:a, dir:c, type:g, datefmt:f});
                return d
            };
            return d
        }(f, null)
                ...
                if ("TABLE" != this.tagName.toUpperCase())alert("Element is not a table"); else if (void 0 !== document.documentMode && 5 >= document.documentMode)alert("Grid can not be used in this ('quirks') mode!"); else {
                    ...
                    if (this.p.colNames.length !== this.p.colModel.length)alert(b.jgrid.errors.model); else {
                        ...
                        var o = function (a, b) {
                                ...
                                if (e === 0)y = y + ("width: " + c.headers[d].width + "px;"); else if (k.cellattr && b.isFunction(k.cellattr))if ((d = k.cellattr.call(a, i, f, h, k, j)) && typeof d === "string") {
                                ...
                                if (!a.grid.hDiv.loading) {
                                    ...
                                    if (!(e === false || e === "stop"))if (b.isFunction(a.p.datatype))a.p.datatype.call(a, a.p.postData, "load_" + a.p.id); else {
                                        ...
                                        switch (f) {
                                            ...
                                            case "xml":
                                            case "script":
                                                b.ajax(b.extend({url:a.p.url, type:a.p.mtype, dataType:f, data:b.isFunction(a.p.serializeGridData) ? a.p.serializeGridData.call(a, a.p.postData) : a.p.postData, success:function (e, g, h) {
                        ...
                        this.p.multiselect && (this.p.colNames.unshift("<input role='checkbox' id='cb_" + this.p.id + "' class='cbox' type='checkbox'/>"), this.p.colModel.unshift({name:"cb", width:b.jgrid.cellWidth() ? a.p.multiselectWidth +
                        ...
                        j = null;
                        D && b(c.hDiv).hide();
                        a.p.pager && ("string" == typeof a.p.pager ? "#" != a.p.pager.substr(0, 1) && (a.p.pager = "#" + a.p.pager) : a.p.pager = "#" + b(a.p.pager).attr("id"), b(a.p.pager).css({width:c.width + "px"}).appendTo(m).addClass("ui-state-default ui-jqgrid-pager ui-corner-bottom"), D && b(a.p.pager).hide(), l(a.p.pager, ""));
    ...
    b.jgrid.extend({getGridParam:function (b) {
        ...
        this.each(function () {
            var h = this, i, j;
            if ("undefined" == typeof f)d = !0, c = [], a = h.rows.length; else {
            ...
            for (; g < a;)d && (j = h.rows[g]), b(j).hasClass("jqgrow") && (b('td[role="gridcell"]', j).each(function (a) {
                ...
                if ("cb" !==
                    ...
                    e[i] = b.unformat.call(h, this, {rowId:j.id, colModel:h.p.colModel[a]}, a)
                } catch (c) {
        ...
        this.each(function () {
            ...
            if (e)try {
                if (b(this.p.colModel).each(function (a) {
                    d = this.name;
                    void 0 !== e[d] && (k[d] = this.formatter && "string" === typeof this.formatter && "date" == this.formatter ? b.unformat.date.call(h, e[d], this) : e[d], i = h.formatter(f, e[d], a, e, "edit"), g = this.title ? {title:b.jgrid.stripHtml(i)} : {}, !0 === h.p.treeGrid && d == h.p.ExpandColumn ? b("td:eq(" + a + ") > span:first", j).html(i).attr(g) : b("td:eq(" + a + ")", j).html(i).attr(g))
                }), "local" == h.p.datatype) {
                    var m = b.jgrid.stripPref(h.p.idPrefix, f), o = h.p._index[m];
                    if (h.p.treeGrid)for (var p in h.p.treeReader)k.hasOwnProperty(h.p.treeReader[p]) && delete k[h.p.treeReader[p]];
                    "undefined" != typeof o && (h.p.data[o] = b.extend(!0, h.p.data[o], k));
                    k = null
                }
            } catch (v) {
                a = !1
        ...
        return this.each(function () {
            ...
            if (this.grid && (isNaN(e) ? b(this.p.colModel).each(function (a) {
                ...
                var l = b("td:eq(" + h + ")", i);
                if ("" !== c || !0 === g)i = this.formatter(f, c, h, i, "edit"), j = this.p.colModel[h].title ? {title:b.jgrid.stripHtml(i)} : {}, this.p.treeGrid && 0 < b(".tree-wrap", b(l)).length ? b("span", b(l)).html(i).attr(j) : b(l).html(i).attr(j), "local" == this.p.datatype && (i = this.p.colModel[h],
                ...
                if (k && 0 < k) {
                    for (; m < k;) {
                        if (b(this.rows[m]).hasClass("jqgrow")) {
                            ...
                            c ? (j = parseFloat(a), g += j, void 0 === i && (i = h = j), h = Math.min(h, j), i = Math.max(i, j)) : e ? d.push({id:this.rows[m].id, value:a}) : d.push(a)
                        }
                        m++
                    }
        ...
        var e = b.extend({onEnter:null, onSpace:null, onLeftKey:null, onRightKey:null, scrollingRows:!0}, f || {});
        return this.each(function () {
            var c = this;
...
(function (c) {
    ...
    c.fmatter.util = {NumberFormat:function (a, b) {
        ...
        var e = /^\/Date\((([-+])?[0-9]+)(([-+])([0-9]{2})([0-9]{2}))?\)\/$/, g = "string" ===
            ...
            return a
        }, h = {m:1, d:1, y:1970, h:0, i:0, s:0, u:0}, i = 0, j, k = ["i18n"];
        k.i18n = {dayNames:d.dayNames, monthNames:d.monthNames};
        a in d.masks && (a = d.masks[a]);
        if (!isNaN(b - 0) && "u" == ("" + a).toLowerCase())i = new Date(1E3 * parseFloat(b)); else if (b.constructor === Date)i = b; else if (null !== g)i = new Date(parseInt(g[1], 10)), g[3] && (a = 60 * Number(g[5]) + Number(g[6]), a *= "-" == g[4] ? 1 : -1, a -= i.getTimezoneOffset(), i.setTime(Number(Number(i) + 6E4 * a)));
        else {
            b = ("" + b).split(/[\\\/:_;.,\t\T\s-]/);
            a = a.split(/[\\\/:_;.,\t\T\s-]/);
            g = 0;
    ...
    c.fn.fmatter.showlink = function (a, b) {
        var f = {baseLinkUrl:b.baseLinkUrl, showAction:b.showAction, addParam:b.addParam || "", target:b.target, idName:b.idName}, d = "";
        void 0 !== b.colModel && !c.fmatter.isUndefined(b.colModel.formatoptions) && (f = c.extend({}, f, b.colModel.formatoptions));
        f.target && (d = "target=" + f.target);
    ...
    c.fn.fmatter.select = function (a, b) {
        ...
        if (f) {
            ...
            if (c.fmatter.isString(f))for (var j = f.split(g), k = 0, l = 0; l < j.length; l++)if (g = j[l].split(e), 2 < g.length && (g[1] = c.map(g,function (a, b) {
                if (b > 0)return a
            }).join(e)), h)-1 < c.inArray(g[0], i) && (d[k] = g[1], k++); else {
    ...
    c.fn.fmatter.rowactions = function (a, b, f, d) {
        var e = {keys:!1, onEdit:null, onSuccess:null, afterSave:null, onError:null, afterRestore:null, extraparam:{}, url:null, restoreAfterError:!0, mtype:"POST", delOptions:{}, editOptions:{}}, a = c.jgrid.jqID(a), b = c.jgrid.jqID(b), d = c("#" + b)[0].p.colModel[d];
        ...
        h = {keys:e.keys,
            oneditfunc:e.onEdit, successfunc:e.onSuccess, url:e.url, extraparam:e.extraparam, aftersavefunc:function (d, f) {
                c.isFunction(e.afterSave) && e.afterSave.call(g, d, f);
                c("tr#" + a + " div.ui-inline-edit, tr#" + a + " div.ui-inline-del", "#" + b + ".ui-jqgrid-btable:first").show();
                c("tr#" + a + " div.ui-inline-save, tr#" + a + " div.ui-inline-cancel", "#" + b + ".ui-jqgrid-btable:first").hide()
            }, errorfunc:e.onError, afterrestorefunc:d, restoreAfterError:e.restoreAfterError, mtype:e.mtype};
        switch (f) {
            case "edit":
                c("#" + b).jqGrid("editRow",
                    a, h);
    ...
    c.fn.fmatter.actions = function (a, b) {
        var f = {keys:!1, editbutton:!0, delbutton:!0, editformbutton:!1};
    ...
    c.unformat = function (a, b, f, d) {
        ...
        if ("undefined" !== typeof j && c.isFunction(j))e = j.call(this, c(a).text(), b, a); else if (!c.fmatter.isUndefined(g) && c.fmatter.isString(g))switch (e = c.jgrid.formatter || {}, g) {
            case "integer":
    ...
    c.unformat.select = function (a, b, f, d) {
        ...
        if (d.value) {
            ...
            if (c.fmatter.isString(g))for (var i = g.split(e), j = 0, k = 0; k < i.length; k++)if (e = i[k].split(b), 2 < e.length && (e[1] = c.map(e,function (a, b) {
                if (b > 0)return a
            }).join(b)), d)-1 < c.inArray(e[1], h) && (f[j] = e[0], j++); else {
        ...
        setGridState:function (b) {
            ...
            return this.each(function () {
                ...
                if (!this.ftoolbar) {
                    var e = function () {
                        ...
                        r || a(c).jqGrid("setGridParam", {search:e}).trigger("reloadGrid", [
                            {page:1}
                        ]);
                        p && a(c).jqGrid("setGridParam", {url:p});
                    ...
                    a.each(c.p.colModel, function () {
                        ...
                        if (this.search)switch (this.stype) {
                            case "select":
                                if (n = this.surl || f.dataUrl)a.ajax(a.extend({url:n, dataType:"html", success:function (c) {
                                    if (f.buildSelect !== void 0)(c = f.buildSelect(c)) && a(j).append(c); else a(j).append(c);
                                    f.defaultValue !==
                                        void 0 && a("select", j).val(f.defaultValue);
                                    a("select", j).attr({name:i.index || i.name, id:"gs_" + i.name});
                                    ...
                                    if (m) {
                                        ...
                                        n.style.width = "100%";
                                        a(n).attr({name:i.index || i.name, id:"gs_" + i.name});
                                        var l;
                                        if ("string" === typeof m) {
                                            m = m.split(k);
                                            for (var p = 0; p < m.length; p++)l =
                                                m[p].split(o), k = document.createElement("option"), k.value = l[0], k.innerHTML = l[1], n.appendChild(k)
                                        } else if ("object" === typeof m)for (l in m)m.hasOwnProperty(l) && (k = document.createElement("option"), k.value = l, k.innerHTML = m[l], n.appendChild(k));
                    ...
                    this.clearToolbar = function (d) {
                        ...
                        if (!0 === b.stringResult ||
                            ...
                            e += "]}";
                            a.extend(c.p.postData, {filters:e});
                            a.each(["searchField", "searchString", "searchOper"], function (a, b) {
                                c.p.postData.hasOwnProperty(b) && delete c.p.postData[b]
                            })
                        ...
                        l || d && a(c).jqGrid("setGridParam", {search:h}).trigger("reloadGrid", [
                            {page:1}
                        ]);
            ...
            return this.each(function () {
                ...
                if (c) {
                    ...
                    d = a("<tr>", {role:"rowheader"}).addClass("ui-jqgrid-labels");
                    h = c.headers;
                    c = 0;
            ...
            return this.each(function () {
                ...
                var p, r = function (a, b) {
                    for (var c = 0, d = b.length; c < d; c++)if (b[c].startColumnName === a)return c;
                    return-1
                };
                a(this).prepend(h);
                h = a("<tr>", {role:"rowheader"}).addClass("ui-jqgrid-labels jqg-third-row-header");
                for (d = 0; d < n; d++)if (i = m[d].el, j = a(i), c = f[d], g = {height:"0px", width:m[d].width + "px", display:c.hidden ? "none" : ""}, a("<th>",
                    ...
                    g = a("<th>").attr({role:"columnheader"}).addClass("ui-state-default ui-th-column-header ui-th-" + this.p.direction).css({height:"22px", "border-top":"0px none"}).html(q);
                    ...
                    h.append(i);
                    e -= 1
                } else 0 === e ? b.useColSpanStyle ? j.attr("rowspan", "2") : (a("<th>", {role:"columnheader"}).addClass("ui-state-default ui-th-column-header ui-th-" + this.p.direction).css({display:c.hidden ? "none" : "", "border-top":"0px none"}).insertBefore(j), h.append(i)) : (h.append(i), e--);
...
(function (a) {
    a.extend(a.jgrid, {showModal:function (a) {
        ...
        b = {};
        if (a.fn.jqm && !0 === c.jqModal)0 === c.left && (0 === c.top && c.overlay) && (i = [], i = a.jgrid.findPos(g), c.left = i[0] + 4, c.top = i[1] + 4), b.top = c.top + "px", b.left = c.left; else if (0 !== c.left || 0 !== c.top)b.left =
        ...
        b.left && (b.left += "px");
        a(e).css(a.extend({width:isNaN(c.width) ? "auto" : c.width + "px", height:isNaN(c.height) ? "auto" : c.height + "px", zIndex:c.zIndex, overflow:"hidden"}, b)).attr({tabIndex:"-1", role:"dialog", "aria-labelledby":d.modalhead, "aria-hidden":"true"});
        ...
        var g = {width:290, height:"auto", dataheight:"auto", drag:!0, resize:!1, caption:"<b>" + d + "</b>", left:250, top:170, zIndex:1E3, jqModal:!0, modal:!1, closeOnEscape:!0, align:"center", buttonalign:"center", buttons:[]};
        a.extend(g, f || {});
        ...
        switch (d) {
            case "textarea":
                ...
                f ? b.cols || a(e).css({width:"98%"}) : b.cols || (b.cols = 20);
                b.rows || (b.rows = 2);
            ...
            case "select":
                ...
                if ("undefined" != typeof b.dataUrl)a.ajax(a.extend({url:b.dataUrl,
            ...
            case "custom":
                ...
                try {
                    if (a.isFunction(b.custom_element))if (m = b.custom_element.call(l, c, b))m = a(m).addClass("customelement").attr({id:b.id, name:b.name}), a(e).empty().append(m); else throw"e2"; else throw"e1";
                } catch (o) {
    ...
    a.jgrid.extend({searchGrid:function (c) {
        ...
        return this.each(function () {
            function d(b) {
                ...
                r && (a.jgrid.viewModal("#" + a.jgrid.jqID(u.themodal), {gbox:"#gbox_" + a.jgrid.jqID(n), jqm:c.jqModal,
            ...
            var e = this;
            if (e.grid) {
                var n = "fbox_" + e.p.id, r = !0, u = {themodal:"searchmod" + n, modalhead:"searchhd" + n, modalcontent:"searchcnt" + n, scrollelm:n}, t = e.p.postData[c.sFilter];
                ...
                if (void 0 !== a("#" + a.jgrid.jqID(u.themodal))[0])d(a("#fbox_" + a.jgrid.jqID(+e.p.id)));
                    ...
                    n = a.jgrid.jqID(n);
                    a("#" + n).jqFilter({columns:p, filter:c.loadDefaults ? t : null, showQuery:c.showQuery, errorcheck:c.errorcheck, sopt:c.sopt, groupButton:c.multipleGroup, ruleButtons:c.multipleSearch, afterRedraw:c.afterRedraw, _gridsopt:a.jgrid.search.odata, ajaxSelectOptions:e.p.ajaxSelectOptions,
                    ...
                    c.gbox = "#gbox_" + n;
                    c.layer ? a.jgrid.createModal(u, l, c, "#gview_" + a.jgrid.jqID(e.p.id), a("#gbox_" + a.jgrid.jqID(e.p.id))[0], "#" + a.jgrid.jqID(c.layer), {position:"relative"}) : a.jgrid.createModal(u, l, c, "#gview_" + a.jgrid.jqID(e.p.id), a("#gbox_" + a.jgrid.jqID(e.p.id))[0]);
                    ...
                    a("#" + n + "_search").bind("click", function () {
                        ...
                        c.closeAfterSearch && a.jgrid.hideModal("#" + a.jgrid.jqID(u.themodal), {gb:"#gbox_" + a.jgrid.jqID(e.p.id), jqm:c.jqModal, onClose:c.onClose});
                        return false
                    });
        ...
        return this.each(function () {
                ...
                a(e.p.colModel).each(function (o) {
                    ...
                    if ("cb" !== f && "subgrid" !== f && !0 === this.editable && "rn" !== f) {
                        if (!1 === v)i = ""; else if (f == e.p.ExpandColumn && !0 === e.p.treeGrid)i = a("td:eq(" + o + ")", e.rows[v]).text(); else {
                            try {
                                i = a.unformat.call(e, a("td:eq(" + o + ")", e.rows[v]), {rowId:d, colModel:this}, o)
                            } catch (s) {
                        ...
                        var r = a.extend({}, this.editoptions || {}, {id:f, name:f}), t = a.extend({}, {elmprefix:"", elmsuffix:"", rowabove:!1, rowcontent:""}, this.formoptions || {}), u = parseInt(t.rowpos, 10) || j + 1, y = parseInt(2 * (parseInt(t.colpos, 10) || 1), 10);
                    ...
                    n && (a('td[role="gridcell"]', n).each(function (m) {
                        ...
                        if ("cb" !== f && "subgrid" !== f && "rn" !== f && !0 === o[m].editable) {
                            if (f == e.p.ExpandColumn && !0 === e.p.treeGrid)g = a(this).text(); else try {
                                g = a.unformat.call(e, a(this), {rowId:d, colModel:o[m]}, m)
                            } catch (i) {
            ...
            function t() {
                ...
                for (l in k)if (k.hasOwnProperty(l) && (f = a.jgrid.checkValues.call(b, k[l], l, b), !1 === f[0]))break;
                u();
                ...
                if (f[0] && !c[b.p.id].processing) {
                    ...
                    (m = b.p.treeReader[v], k.hasOwnProperty(m) && !(k[o] == g.addoper && "parent_id_field" === v) && delete k[m]);
                    k[j] = a.jgrid.stripPref(b.p.idPrefix, k[j]);
                    v = a.extend({url:c[b.p.id].url ? c[b.p.id].url : a(b).jqGrid("getGridParam", "editurl"), type:c[b.p.id].mtype, data:a.isFunction(c[b.p.id].serializeEditData) ? c[b.p.id].serializeEditData.call(b, k) : k, complete:function (m, l) {
                        ...
                        if (f[0] === false) {
                            ...
                            if (k[o] == g.addoper) {
                                ...
                                if (c[b.p.id].closeAfterAdd) {
                                    if (c[b.p.id].reloadAfterSubmit)a(b).trigger("reloadGrid"); else if (b.p.treeGrid === true)a(b).jqGrid("addChildNode", f[2], n, k); else {
                                        a(b).jqGrid("addRowData", f[2], k, d.addedrow);
                                        a(b).jqGrid("setSelection", f[2])
                                    }
                                    a.jgrid.hideModal("#" + a.jgrid.jqID(q.themodal), {gb:"#gbox_" + a.jgrid.jqID(s), jqm:d.jqModal, onClose:c[b.p.id].onClose})
                                ...
                                c[b.p.id].closeAfterEdit && a.jgrid.hideModal("#" + a.jgrid.jqID(q.themodal), {gb:"#gbox_" + a.jgrid.jqID(s), jqm:d.jqModal, onClose:c[b.p.id].onClose})
                            }
            ...
            if (b.grid && o) {
                ...
                if (void 0 !== a("#" + a.jgrid.jqID(q.themodal))[0]) {
                    ...
                    a("#" + a.jgrid.jqID(q.themodal)).data("onClose",
                        c[b.p.id].onClose);
                    a.jgrid.viewModal("#" + a.jgrid.jqID(q.themodal), {gbox:"#gbox_" + a.jgrid.jqID(s), jqm:d.jqModal, jqM:!1, overlay:d.overlay, modal:d.modal});
                    ...
                    if (c[b.p.id].checkOnSubmit || c[b.p.id].checkOnUpdate)J = "<a href='javascript:void(0)' id='sNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>" + d.bYes + "</a>", D = "<a href='javascript:void(0)' id='nNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>" + d.bNo + "</a>", K = "<a href='javascript:void(0)' id='cNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>" +
                        ...
                        a(".confirm", "#" + a.jgrid.jqID(q.themodal)).hide();
                        a("#" + h).data("disabled", false);
                        a.jgrid.hideModal("#" + a.jgrid.jqID(q.themodal), {gb:"#gbox_" +
                    ...
                    a.jgrid.viewModal("#" + a.jgrid.jqID(q.themodal), {gbox:"#gbox_" + a.jgrid.jqID(s), jqm:d.jqModal,
                    ...
                    a("#sData", i + "_2").click(function () {
                        ...
                        a("#FormError", i).hide();
                        e();
                        if (k[b.p.id + "_id"] == "_empty")t(); else if (d.checkOnSubmit === true) {
                            F = a.extend({}, k, B);
        ...
        d = a.extend({top:0, left:0, width:0, height:"auto", dataheight:"auto", modal:!1, overlay:30, drag:!0,
            resize:!0, jqModal:!0, closeOnEscape:!1, labelswidth:"30%", closeicon:[], navkeys:[!1, 38, 40], onClose:null, beforeShowForm:null, beforeInitData:null, viewPagerButtons:!0}, a.jgrid.view, d || {});
        c[a(this)[0].p.id] = d;
        return this.each(function () {
            function e() {
            ...
            function n(b, c, e, f) {
                ...
                a(c.p.colModel).each(function (b) {
                    ...
                    if ("cb" !== g && "subgrid" !== g && "rn" !== g && w) {
                        ...
                        x = "right" ===
                            this.align && 0 !== y ? !0 : !1;
                        var d = a.extend({}, {rowabove:!1, rowcontent:""}, this.formoptions || {}), m = parseInt(d.rowpos, 10) || i + 1, p = parseInt(2 * (parseInt(d.colpos, 10) || 1), 10);
                        if (d.rowabove) {
                        ...
                        x && a("td:eq(" + (p - 1) + ") span", j[0]).css({"text-align":"right", width:y + "px"});
                        l[i] = b;
                        i++
                    }
                });
            ...
            if (l.grid && o) {
                ...
                if (void 0 !== a("#" + a.jgrid.jqID(s.themodal))[0]) {
                    ...
                    a.jgrid.viewModal("#" + a.jgrid.jqID(s.themodal), {gbox:"#gbox_" + a.jgrid.jqID(g), jqm:d.jqModal, jqM:!1, overlay:d.overlay, modal:d.modal});
                    e()
                } else {
                    ...
                    a("#" + s.themodal).keydown(function (b) {
                        if (b.which === 27) {
                            c[l.p.id].closeOnEscape && a.jgrid.hideModal(this, {gb:d.gbox, jqm:d.jqModal, onClose:d.onClose});
                            return false
                        }
                        if (d.navkeys[0] === true) {
                    ...
                    a.jgrid.viewModal("#" + a.jgrid.jqID(s.themodal), {gbox:"#gbox_" + a.jgrid.jqID(g), jqm:d.jqModal, modal:d.modal});
                    ...
                    a("#cData", "#" + p + "_2").click(function () {
                        a.jgrid.hideModal("#" + a.jgrid.jqID(s.themodal), {gb:"#gbox_" + a.jgrid.jqID(g), jqm:d.jqModal, onClose:d.onClose});
                        return false
                    });
        ...
        d = a.extend({top:0, left:0, width:240, height:"auto", dataheight:"auto", modal:!1, overlay:30, drag:!0, resize:!0, url:"", mtype:"POST", reloadAfterSubmit:!0, beforeShowForm:null, beforeInitData:null, afterShowForm:null, beforeSubmit:null, onclickSubmit:null, afterSubmit:null, jqModal:!0, closeOnEscape:!1, delData:{}, delicon:[], cancelicon:[], onClose:null, ajaxDelOptions:{}, processing:!1, serializeDelData:null, useDataProxy:!1}, a.jgrid.del, d || {});
        c[a(this)[0].p.id] = d;
        return this.each(function () {
            var e =
                this;
            if (e.grid && o) {
                var n = a.isFunction(c[e.p.id].beforeShowForm), r = a.isFunction(c[e.p.id].afterShowForm), u = a.isFunction(c[e.p.id].beforeInitData) ? c[e.p.id].beforeInitData : !1, t = e.p.id, l = {}, g = !0, f = "DelTbl_" + a.jgrid.jqID(t), p, w, b, s, h = "DelTbl_" + t, j = {themodal:"delmod" + t, modalhead:"delhd" + t, modalcontent:"delcnt" + t, scrollelm:f};
                ...
                if (void 0 !== a("#" + a.jgrid.jqID(j.themodal))[0]) {
                    ...
                    a.jgrid.viewModal("#" + a.jgrid.jqID(j.themodal), {gbox:"#gbox_" + a.jgrid.jqID(t), jqm:c[e.p.id].jqModal, jqM:!1, overlay:c[e.p.id].overlay, modal:c[e.p.id].modal})
                } else {
                    ...
                    a("#dData", "#" + f + "_2").click(function () {
                        ...
                        if (g[0] && !c[e.p.id].processing) {
                            ...
                            (h[i] = a.jgrid.stripPref(e.p.idPrefix, h[i]));
                            p[w] = h.join();
                            a(this).addClass("ui-state-active");
                            i = a.extend({url:c[e.p.id].url ? c[e.p.id].url : a(e).jqGrid("getGridParam", "editurl"), type:c[e.p.id].mtype, data:a.isFunction(c[e.p.id].serializeDelData) ? c[e.p.id].serializeDelData.call(e, p) : p, complete:function (b, i) {
                                if (i != "success") {
                                    g[0] = false;
                                ...
                                g[0] && a.jgrid.hideModal("#" + a.jgrid.jqID(j.themodal), {gb:"#gbox_" + a.jgrid.jqID(t), jqm:d.jqModal, onClose:c[e.p.id].onClose})
                            }}, a.jgrid.ajaxOptions, c[e.p.id].ajaxDelOptions);
                            if (!i.url && !c[e.p.id].useDataProxy)if (a.isFunction(e.p.dataProxy))c[e.p.id].useDataProxy = true; else {
                                g[0] = false;
                            ...
                            if (g[0])if (c[e.p.id].useDataProxy) {
                                ...
                                } else a.jgrid.hideModal("#" + a.jgrid.jqID(j.themodal), {gb:"#gbox_" + a.jgrid.jqID(t), jqm:d.jqModal, onClose:c[e.p.id].onClose})
                            } else a.ajax(i)
                        }
                        if (g[0] === false) {
                            a("#DelError>td", "#" + f).html(g[1]);
                    ...
                    a("#eData", "#" + f + "_2").click(function () {
                        a.jgrid.hideModal("#" + a.jgrid.jqID(j.themodal), {gb:"#gbox_" + a.jgrid.jqID(t), jqm:c[e.p.id].jqModal, onClose:c[e.p.id].onClose});
                        return false
                    });
                    n && c[e.p.id].beforeShowForm.call(e,
                        a("#" + f));
                    a.jgrid.viewModal("#" + a.jgrid.jqID(j.themodal), {gbox:"#gbox_" + a.jgrid.jqID(t), jqm:c[e.p.id].jqModal, overlay:c[e.p.id].overlay, modal:c[e.p.id].modal})
                }
        ...
        d = a.extend({edit:!0, editicon:"ui-icon-pencil", add:!0, addicon:"ui-icon-plus", del:!0, delicon:"ui-icon-trash", search:!0, searchicon:"ui-icon-search",
            refresh:!0, refreshicon:"ui-icon-refresh", refreshstate:"firstpage", view:!1, viewicon:"ui-icon-document", position:"left", closeOnEscape:!0, beforeRefresh:null, afterRefresh:null, cloneToTop:!1, alertwidth:200, alertheight:"auto", alerttop:null, alertleft:null, alertzIndex:null}, a.jgrid.nav, d || {});
        return this.each(function () {
            if (!this.nav) {
                var l = {themodal:"alertmod", modalhead:"alerthd", modalcontent:"alertcnt"}, g = this, f;
                if (g.grid && "string" == typeof c) {
                    void 0 === a("#" + l.themodal)[0] && (!d.alerttop && !d.alertleft && ("undefined" !=
                        ...
                        {gbox:"#gbox_" + a.jgrid.jqID(g.p.id), jqModal:!0, drag:!0, resize:!0, caption:d.alertcap, top:d.alerttop, left:d.alertleft, width:d.alertwidth, height:d.alertheight, closeOnEscape:d.closeOnEscape, zIndex:d.alertzIndex}, "", "", !0));
                    var p = 1;
                    ...
                    for (var w = 0; w < p; w++) {
                        ...
                        d.add && (n = n || {}, f = a("<td class='ui-pg-button ui-corner-all'></td>"), a(f).append("<div class='ui-pg-div'><span class='ui-icon " + d.addicon + "'></span>" + d.addtext + "</div>"), a("tr", b).append(f), a(f, b).attr({title:d.addtitle || "", id:n.id || "add_" + h}).click(function () {
                        ...
                        d.edit && (f = a("<td class='ui-pg-button ui-corner-all'></td>"), e = e || {}, a(f).append("<div class='ui-pg-div'><span class='ui-icon " + d.editicon + "'></span>" + d.edittext + "</div>"), a("tr", b).append(f), a(f, b).attr({title:d.edittitle || "", id:e.id || "edit_" + h}).click(function () {
                            if (!a(this).hasClass("ui-state-disabled")) {
                                var b = g.p.selrow;
                                if (b)a.isFunction(d.editfunc) ? d.editfunc.call(g, b) : a(g).jqGrid("editGridRow", b, e);
                                else {
                                    a.jgrid.viewModal("#" + l.themodal, {gbox:"#gbox_" + a.jgrid.jqID(g.p.id), jqm:true});
                                    a("#jqg_alrt").focus()
                                }
                            }
                            return false
                        ...
                        d.view && (f = a("<td class='ui-pg-button ui-corner-all'></td>"), t = t || {}, a(f).append("<div class='ui-pg-div'><span class='ui-icon " + d.viewicon + "'></span>" + d.viewtext + "</div>"), a("tr", b).append(f), a(f, b).attr({title:d.viewtitle || "",
                            id:t.id || "view_" + h}).click(function () {
                                if (!a(this).hasClass("ui-state-disabled")) {
                                    var b = g.p.selrow;
                                    if (b)a.isFunction(d.viewfunc) ? d.viewfunc.call(g, b) : a(g).jqGrid("viewGridRow", b, t); else {
                                        a.jgrid.viewModal("#" + l.themodal, {gbox:"#gbox_" + a.jgrid.jqID(g.p.id), jqm:true});
                                        a("#jqg_alrt").focus()
                                    }
                                }
                        ...
                        d.del && (f = a("<td class='ui-pg-button ui-corner-all'></td>"),
                            r = r || {}, a(f).append("<div class='ui-pg-div'><span class='ui-icon " + d.delicon + "'></span>" + d.deltext + "</div>"), a("tr", b).append(f), a(f, b).attr({title:d.deltitle || "", id:r.id || "del_" + h}).click(function () {
                            if (!a(this).hasClass("ui-state-disabled")) {
                                var b;
                                if (g.p.multiselect) {
                                    b = g.p.selarrrow;
                                ...
                                if (b)a.isFunction(d.delfunc) ? d.delfunc.call(g, b) : a(g).jqGrid("delGridRow", b, r); else {
                                    a.jgrid.viewModal("#" + l.themodal, {gbox:"#gbox_" + a.jgrid.jqID(g.p.id), jqm:true});
                                    a("#jqg_alrt").focus()
                                }
                            }
                        ...
                        d.search && (f = a("<td class='ui-pg-button ui-corner-all'></td>"), u = u || {}, a(f).append("<div class='ui-pg-div'><span class='ui-icon " + d.searchicon + "'></span>" + d.searchtext + "</div>"), a("tr", b).append(f), a(f, b).attr({title:d.searchtitle || "", id:u.id || "search_" +
                            h}).click(function () {
...
(function (a) {
    ...
    a.jgrid.extend({editRow:function (c, d, b, k, g, l, p, h, e) {
        var j = {}, f = a.makeArray(arguments).slice(1);
        if ("object" === a.type(f[0]))j = f[0]; else if ("undefined" !== typeof d && (j.keys = d), a.isFunction(b) && (j.oneditfunc = b), a.isFunction(k) && (j.successfunc = k), "undefined" !== typeof g && (j.url = g), "undefined" !== typeof l && (j.extraparam = l), a.isFunction(p) && (j.aftersavefunc = p), a.isFunction(h) && (j.errorfunc = h), a.isFunction(e))j.afterrestorefunc = e;
        j = a.extend(!0, {keys:!1,
            oneditfunc:null, successfunc:null, url:null, extraparam:{}, aftersavefunc:null, errorfunc:null, afterrestorefunc:null, restoreAfterError:!0, mtype:"POST"}, a.jgrid.inlineEdit, j);
        return this.each(function () {
            ...
            e.grid && (m = a(e).jqGrid("getInd", c, !0), !1 !== m && (f = a(m).attr("editable") || "0", "0" == f && !a(m).hasClass("not-editable-row") && (n = e.p.colModel, a('td[role="gridcell"]', m).each(function (f) {
                ...
                if (j)b = a("span:first", this).html();
                    ...
                    b = a.unformat.call(e, this, {rowId:c, colModel:n[f]}, f)
                } catch (m) {
                ...
                if ("cb" != d && ("subgrid" != d && "rn" != d) && (e.p.autoencode && (b = a.jgrid.htmlDecode(b)), l[d] = b, !0 === n[f].editable)) {
                    ...
                    var k = a.extend({}, n[f].editoptions || {}, {id:c + "_" + d, name:d});
        ...
        if ("object" === a.type(h[0]))e = h[0]; else if (a.isFunction(d) &&
        ...
        var e = a.extend(!0, {successfunc:null, url:null, extraparam:{}, aftersavefunc:null, errorfunc:null, afterrestorefunc:null, restoreAfterError:!0, mtype:"POST"}, a.jgrid.inlineEdit, e), j = !1, f = this[0], o, i = {}, u = {}, r = {}, t, s, q;
        if (!f.grid)return j;
        ...
        if ("1" === h) {
            ...
            if (!1 === s[0]) {
                try {
                    ...
                    a.jgrid.info_dialog(a.jgrid.errors.errcap, s[1], a.jgrid.edit.bClose, {left:n[0], top:n[1]})
                } catch (w) {
                    alert(s[1])
                }
                return j
            ...
            if ("clientArray" == e.url) {
                ...
                a(f).triggerHandler("jqGridInlineErrorSaveRow",
                    [c, b, d, g, e]);
                if (a.isFunction(e.errorfunc))e.errorfunc.call(f, c, b, d, g); else {
        ...
        c = a.extend(!0, {rowID:"new_row", initdata:{}, position:"first", useDefValues:!0, useFormatter:!1, addRowParams:{extraparam:{}}}, c || {});
        return this.each(function () {
            if (this.grid) {
                var d =
                    this;
                ...
                if (c.useFormatter)a("#" + a.jgrid.jqID(c.rowID) + " .ui-inline-edit", "#" + a.jgrid.jqID(d.p.id)).click(); else {
                    var b = d.p.prmNames;
        ...
        d = a.extend({edit:!0, editicon:"ui-icon-pencil", add:!0, addicon:"ui-icon-plus", save:!0, saveicon:"ui-icon-disk", cancel:!0, cancelicon:"ui-icon-cancel", addParams:{useFormatter:!1, rowID:"new_row"}, editParams:{}, restoreAfterSelect:!0}, a.jgrid.nav, d || {});
        return this.each(function () {
            if (this.grid) {
                ...
                d.edit && a(b).jqGrid("navButtonAdd", c, {caption:d.edittext, title:d.edittitle, buttonicon:d.editicon, id:b.p.id + "_iledit", onClickButton:function () {
                    var c = a(b).jqGrid("getGridParam",
                        "selrow");
                    c ? (a(b).jqGrid("editRow", c, d.editParams), a("#" + g + "_ilsave").removeClass("ui-state-disabled"), a("#" + g + "_ilcancel").removeClass("ui-state-disabled"), a("#" + g + "_iladd").addClass("ui-state-disabled"), a("#" + g + "_iledit").addClass("ui-state-disabled")) : (a.jgrid.viewModal("#alertmod", {gbox:"#gbox_" + g, jqm:!0}), a("#jqg_alrt").focus())
                }});
                d.save && (a(b).jqGrid("navButtonAdd", c, {caption:d.savetext || "", title:d.savetitle || "Save row", buttonicon:d.saveicon, id:b.p.id + "_ilsave", onClickButton:function () {
                    ...
                    } else a.jgrid.viewModal("#alertmod", {gbox:"#gbox_" + g, jqm:!0}), a("#jqg_alrt").focus()
                }}), a("#" + g + "_ilsave").addClass("ui-state-disabled"));
                d.cancel && (a(b).jqGrid("navButtonAdd", c, {caption:d.canceltext || "", title:d.canceltitle ||
                    "Cancel row editing", buttonicon:d.cancelicon, id:b.p.id + "_ilcancel", onClickButton:function () {
                    var c = b.p.savedRow[0].id;
                    if (c) {
                        a(b).jqGrid("restoreRow", c, d.editParams);
                        a(b).jqGrid("showAddEditButtons")
                    } else {
                        a.jgrid.viewModal("#alertmod", {gbox:"#gbox_" + g, jqm:true});
                        a("#jqg_alrt").focus()
                    }
...
(function (b) {
    ...
    b.jqm = {hash:{}, open:function (a, k) {
        ...
        if (p && (b("html,body").css({height:"100%", width:"100%"}), f)) {
...
(function (b) {
    b.jgrid.extend({setSubGrid:function () {
        return this.each(function () {
            ...
            this.p.colModel.unshift({name:"subgrid", width:b.browser.safari ? this.p.subGridWidth + this.p.cellLayout : this.p.subGridWidth, sortable:!1, resizable:!1, hidedlg:!0, search:!1, fixed:!0});
    ...
    b.jgrid.extend({groupingSetup:function () {
        return this.each(function () {
            ...
            if (null !== a && ("object" === typeof a || b.isFunction(a)))if (a.groupField.length) {
                ...
                a.summary = [];
                for (var c = this.p.colModel, f = 0, e = c.length; f < e; f++)c[f].summaryType && a.summary.push({nm:c[f].name, st:c[f].summaryType, v:"", sr:c[f].summaryRound, srt:c[f].summaryRoundType || "round"})
        ...
        this.each(function () {
            for (var d = this.p.groupingView, h = this, g = d.groupField.length, k, j, p = 0, i = 0; i < g; i++)k = d.groupField[i], j = f[k], void 0 !== j && (0 === e ?
                ...
                1, summary:b.extend(!0, [], d.summary)}) : (d.counters[i].cnt += 1, d.groups[d.counters[i].pos].cnt = d.counters[i].cnt), b.each(d.counters[i].summary, function () {
...
(function (d) {
    d.jgrid.extend({setTreeNode:function (a, c) {
        ...
        return this.each(function () {
            ...
            if (a.p.treeGrid) {
                ...
                b = "ui-icon-triangle-1-" + ("rtl" == a.p.direction ?
                    "w" : "e");
                a.p.treeIcons = d.extend({plus:b, minus:"ui-icon-triangle-1-s", leaf:"ui-icon-radio-off"}, a.p.treeIcons || {});
            ...
            if (this.grid && this.p.treeGrid) {
                ...
                if (void 0 !== l) {
                    ...
                    if ("nested" === this.p.treeGridModel) {
                        c =
                            d.jgrid.from(this.p.data).greater(b, g, {stype:"integer"}).select();
                        if (c.length)for (f in c)c.hasOwnProperty(f) && (c[f][b] = parseInt(c[f][b], 10) - h);
        ...
        if (b) {
            ...
            t = !1;
            if (void 0 === c || null === c || "" === c)r = c = null, m = "last", s = e.p.tree_root_level, o = e.p.data.length + 1; else if (m = "after", k = e.p._index[c], q = e.p.data[k], c = q[e.p.localReader.id], s = parseInt(q[f], 10) + 1, o = d(e).jqGrid("getFullTreeNode", q), o.length ? (r = o = o[o.length - 1][e.p.localReader.id], o = d(e).jqGrid("getInd",
            ...
            if ("nested" === e.p.treeGridModel) {
                ...
                if (null !== c) {
                    ...
                    f = f.greaterOrEquals(i, h, {stype:"integer"});
                    f = f.select();
                    if (f.length)for (n in f)f.hasOwnProperty(n) && (f[n][j] = f[n][j] > h ? parseInt(f[n][j], 10) + 2 : f[n][j], f[n][i] = f[n][i] >= h ? parseInt(f[n][i], 10) + 2 : f[n][i]);
                    b[j] = h;
                    b[i] = h + 1
                } else {
                    h = parseInt(d(e).jqGrid("getCol", i, !1, "max"), 10);
                    f = d.jgrid.from(e.p.data).greater(j, h, {stype:"integer"}).select();
                    if (f.length)for (n in f)f.hasOwnProperty(n) && (f[n][j] = parseInt(f[n][j], 10) + 2);
    ...
    c.jgrid.extend({jqGridImport:function (a) {
            ...
            switch (a.imptype) {
                case "xml":
                    c.ajax(c.extend({url:a.impurl,
                        type:a.mtype, data:a.impData, dataType:"xml", complete:function (f, g) {
                ...
                case "json":
                    c.ajax(c.extend({url:a.impurl,
                        type:a.mtype, data:a.impData, dataType:"json", complete:function (b) {
                            try {
        ...
        this.each(function () {
            if (this.grid) {
                ...
                b.knv = null;
                if (b.treeGrid)for (var g in b.treeReader)b.treeReader.hasOwnProperty(g) && (b.colNames.splice(b.colNames.length - 1), b.colModel.splice(b.colModel.length - 1));
                switch (a.exptype) {
                    case "xmlstring":
                        d =
